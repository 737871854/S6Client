...
public class RenderSettingsWrap
{
	...
	{
		RenderSettings.ambientMode = LuaScriptMgr.GetNetObject<AmbientMode>(L, 3);
		return 0;
	}
	...
	{
		RenderSettings.ambientProbe = LuaScriptMgr.GetNetObject<SphericalHarmonicsL2>(L, 3);
		return 0;
	}
	...
	{
		RenderSettings.defaultReflectionMode = LuaScriptMgr.GetNetObject<DefaultReflectionMode>(L, 3);
		return 0;
	}
	...
	{
		RenderSettings.customReflection = LuaScriptMgr.GetUnityObject<Cubemap>(L, 3);
		return 0;
	}

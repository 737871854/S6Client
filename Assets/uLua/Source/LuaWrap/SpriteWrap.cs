...
public class SpriteWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Sprite", typeof(Sprite), regs, fields, typeof(UnityEngine.Object));
	}
	...
	static int Create(IntPtr L)
	{
		...
		if (count == 3)
		{
			Texture2D arg0 = LuaScriptMgr.GetUnityObject<Texture2D>(L, 1);
	...
	static int OverrideGeometry(IntPtr L)
	{
		...
		Sprite obj = LuaScriptMgr.GetUnityObject<Sprite>(L, 1);

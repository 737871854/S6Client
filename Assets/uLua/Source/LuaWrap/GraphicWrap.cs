...
public class GraphicWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(Graphic));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.UI.Graphic", typeof(Graphic), regs, fields, typeof(UnityEngine.EventSystems.UIBehaviour));
	}
	...
	static int SetAllDirty(IntPtr L)
	{
		...
		Graphic obj = LuaScriptMgr.GetUnityObject<Graphic>(L, 1);
		obj.SetAllDirty();
		return 0;
	}
	...
	static int RegisterDirtyLayoutCallback(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Graphic obj = LuaScriptMgr.GetUnityObject<Graphic>(L, 1);
		UnityAction arg0 = LuaScriptMgr.GetNetObject<UnityAction>(L, 2);

...
public class RenderTextureWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.RenderTexture", typeof(RenderTexture), regs, fields, typeof(UnityEngine.Texture));
	}
	...
	static int set_dimension(IntPtr L)
	{
		...
		obj.dimension = LuaScriptMgr.GetNetObject<TextureDimension>(L, 3);
		return 0;
	}

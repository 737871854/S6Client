...
public class ImageWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(Image));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.UI.Image", typeof(Image), regs, fields, typeof(UnityEngine.UI.MaskableGraphic));
	}
	...
	static int set_sprite(IntPtr L)
	{
		...
		obj.sprite = LuaScriptMgr.GetUnityObject<Sprite>(L, 3);
		return 0;
	}
	...
	static int set_overrideSprite(IntPtr L)
	{
		...
		obj.overrideSprite = LuaScriptMgr.GetUnityObject<Sprite>(L, 3);
		return 0;
	}
	...
	static int set_type(IntPtr L)
	{
		...
		obj.type = LuaScriptMgr.GetNetObject<UnityEngine.UI.Image.Type>(L, 3);
		return 0;
	}
	...
	static int set_fillMethod(IntPtr L)
	{
		...
		obj.fillMethod = LuaScriptMgr.GetNetObject<UnityEngine.UI.Image.FillMethod>(L, 3);
		return 0;
	}
	...
	static int OnBeforeSerialize(IntPtr L)
	{
		...
		Image obj = LuaScriptMgr.GetUnityObject<Image>(L, 1);
	...
	static int IsRaycastLocationValid(IntPtr L)
	{
		...
		Camera arg1 = LuaScriptMgr.GetUnityObject<Camera>(L, 3);

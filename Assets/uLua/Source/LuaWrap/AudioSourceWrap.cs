...
public class AudioSourceWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.AudioSource", typeof(AudioSource), regs, fields, typeof(UnityEngine.Behaviour));
	}
	...
	static int set_outputAudioMixerGroup(IntPtr L)
	{
		...
		obj.outputAudioMixerGroup = LuaScriptMgr.GetUnityObject<AudioMixerGroup>(L, 3);
		return 0;
	}

...
public class TypeWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "System.Type", typeof(Type), regs, fields, null);
	}
	...
	static int GetMethod(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Type), typeof(string), typeof(BindingFlags)))
		{
			Type obj = LuaScriptMgr.GetTypeObject(L, 1);
			string arg0 = LuaScriptMgr.GetString(L, 2);
			BindingFlags arg1 = LuaScriptMgr.GetNetObject<BindingFlags>(L, 3);

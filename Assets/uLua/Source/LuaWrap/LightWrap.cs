...
public class LightWrap
{
	...
	static int set_shadowResolution(IntPtr L)
	{
		...
		obj.shadowResolution = LuaScriptMgr.GetNetObject<LightShadowResolution>(L, 3);
		return 0;
	}
	...
	static int AddCommandBuffer(IntPtr L)
	{
		...
		Light obj = LuaScriptMgr.GetUnityObject<Light>(L, 1);
		LightEvent arg0 = LuaScriptMgr.GetNetObject<LightEvent>(L, 2);

...
public class CameraWrap
{
	...
	{
		Camera.onPreCull = LuaScriptMgr.GetNetObject<UnityEngine.Camera.CameraCallback>(L, 3);
		return 0;
	}
	...
	{
		Camera.onPreRender = LuaScriptMgr.GetNetObject<UnityEngine.Camera.CameraCallback>(L, 3);
		return 0;
	}
	...
	{
		Camera.onPostRender = LuaScriptMgr.GetNetObject<UnityEngine.Camera.CameraCallback>(L, 3);
		return 0;
	}
	...
	static int set_opaqueSortMode(IntPtr L)
	{
		...
		obj.opaqueSortMode = LuaScriptMgr.GetNetObject<OpaqueSortMode>(L, 3);
		return 0;
	}
	...
	static int set_nonJitteredProjectionMatrix(IntPtr L)
	{
		...
		obj.nonJitteredProjectionMatrix = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 3);
		return 0;
	}
	...
	static int set_cameraType(IntPtr L)
	{
		...
		obj.cameraType = LuaScriptMgr.GetNetObject<CameraType>(L, 3);
		return 0;
	}
	...
	static int set_stereoTargetEye(IntPtr L)
	{
		...
		obj.stereoTargetEye = LuaScriptMgr.GetNetObject<StereoTargetEyeMask>(L, 3);
		return 0;
	}
	...
	static int set_cullingMatrix(IntPtr L)
	{
		...
		obj.cullingMatrix = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 3);
		return 0;
	}
	...
	static int SetStereoViewMatrices(IntPtr L)
	{
		...
		Camera obj = LuaScriptMgr.GetUnityObject<Camera>(L, 1);
		Matrix4x4 arg0 = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 2);
	...
	static int AddCommandBuffer(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		Camera obj = LuaScriptMgr.GetUnityObject<Camera>(L, 1);
		CameraEvent arg0 = LuaScriptMgr.GetNetObject<CameraEvent>(L, 2);
		CommandBuffer arg1 = LuaScriptMgr.GetNetObject<CommandBuffer>(L, 3);
	...
	static int GetCommandBuffers(IntPtr L)
	{
		...
		Camera obj = LuaScriptMgr.GetUnityObject<Camera>(L, 1);
		CameraEvent arg0 = LuaScriptMgr.GetNetObject<CameraEvent>(L, 2);
		CommandBuffer[] o = obj.GetCommandBuffers(arg0);

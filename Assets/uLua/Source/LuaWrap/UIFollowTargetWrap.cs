...
public class UIFollowTargetWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(UIFollowTarget));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "UIFollowTarget", typeof(UIFollowTarget), regs, fields, typeof(UnityEngine.MonoBehaviour));
	}
	...
	static int set_gameCamera(IntPtr L)
	{
		...
		obj.gameCamera = LuaScriptMgr.GetUnityObject<Camera>(L, 3);
		return 0;
	}

...
public class RendererWrap
{
	...
	static int set_shadowCastingMode(IntPtr L)
	{
		...
		obj.shadowCastingMode = LuaScriptMgr.GetNetObject<ShadowCastingMode>(L, 3);
		return 0;
	}
	...
	static int set_lightProbeUsage(IntPtr L)
	{
		...
		obj.lightProbeUsage = LuaScriptMgr.GetNetObject<LightProbeUsage>(L, 3);
		return 0;
	}
	...
	static int set_lightProbeProxyVolumeOverride(IntPtr L)
	{
		...
		obj.lightProbeProxyVolumeOverride = LuaScriptMgr.GetUnityObject<GameObject>(L, 3);
		return 0;
	}
	...
	static int set_probeAnchor(IntPtr L)
	{
		...
		obj.probeAnchor = LuaScriptMgr.GetUnityObject<Transform>(L, 3);
		return 0;
	}
